...
const mongoURI = process.env.mongoURI + "insultLibrary"; //URI for connecting to database specified in .env
...
const whitelist = ["http://localhost:3000/", "https://insultslibrary.netlify.app/", "https://insultslibrary.herokuapp.com/"];
const corsOptions = {
